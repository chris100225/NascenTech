...
import bgSolucoesMobile from "@/public/bgSolucoesMobile.png";
...
const challengeMetrics: StatMetric[] = [
  {
    ...
    description:
      "dos CIOs não acreditam que existe transparência adequada com os custos de TI.",
    source: "Fonte: Gartner 2023",
  },
  {
    percentage: 63,
    title: "Falta de valor comunicado",
    description:
      "dos CIOs lutam para comunicar o valor da TI",
    source: "Fonte: Gartner, 2023",
  },
  {
    percentage: 92,
    title: "Valor comercial é crucial",
    description:
      "consideram o valor comercial da tecnologia altamente importante nas decisões orçamentárias.",
    source: "Fonte: HBR, 2021",
  },
];
  ...
  return (<>
    <main>
      ...
      <section className="solucoes"
        style={{
          backgroundImage: `url(${isMobile ? bgSolucoesMobile.src : bgSolucoes.src})`
        }}>
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 md:grid-cols-3 ">
          {challengeMetrics.map((item, idx) => (
            ...
            >
              <h3 className="text-2xl text-center font-bold text-purple-950">{item.title}</h3>
              ...
              <div className="my-8 flex items-center justify-center">
                <div className="relative flex h-36 w-36 items-center justify-center">
                  ...
                  <span className="absolute text-3xl font-black text-purple-950">
                    {item.percentage}%
                  </span>
                </div>
              </div>
              ...
              <span className="mt-4 block text-xs font-semibold text-purple-950">
                {item.source}
              </span>
            </article>
          ))}
